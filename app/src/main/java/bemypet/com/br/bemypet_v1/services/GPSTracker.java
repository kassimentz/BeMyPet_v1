...
/**
 * Created by kassianesmentz on 17/08/17.
 */
...
public class GPSTracker extends Service{
    ...
    //Flag to receive activy on the constructor
    ...
    public Location getLocation(boolean checkActivity) {
        try {
            ...
            if (isGPSEnabled) {
                if (location == null && checkActivity == true) {
